...
from app.db.mongodb import MongoDBSingleton  # Adjust import path as needed
...
class TestMongoDBSingleton:
    ...
    def test_initialize_client(self, mock_mongo_client):
        ...
        # Assert MongoClient was called with correct parameters
        ...
        # Assert ping command was called
